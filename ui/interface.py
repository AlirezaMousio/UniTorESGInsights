...
def build_interface():
    ...
    with gr.Blocks(
        ...
        extracted_download = gr.File(
            label="Download Extracted CSV"
        )

        upload_csv_1 = gr.File(
            label="(Optional) Upload Custom CSV"
        )
        ...
        gr.Markdown(
            "## Step 2: Sustainability Frameworks Alignment"
        )
        ...
        upload_csv_2 = gr.File(
            label="(Optional) Upload Modified SFA CSV"
        )
